...
Single-pin nets: 541 total -- 395 deliberately named (`pending-port`: a real hierarchical port net, expected to be single-pin until the far sheet exists -- not a problem by itself), 28 on known staged/standard parts (`cradle_sidecar/data/altium/standard-parts.md` -- expected, excluded from review below), and 118 genuinely unexplained auto-named orphans -- these are the real candidates for review/No Connect.
