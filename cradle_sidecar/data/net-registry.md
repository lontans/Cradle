...
| `WIRELESS_SDCMD` | Compute-SoC <-> Wireless (bidirectional) | Compute-SoC <-> Wireless (bidirectional) | 1.8V | 30kOhm pull-up (Wireless) | SDIO 3.0 | TBD | pending |
| `WIRELESS_SDCLK` | Compute-SoC <-> Wireless (bidirectional per datasheet Type=I/O) | Compute-SoC <-> Wireless (bidirectional per datasheet Type=I/O) | 1.8V | 0Ohm series (Wireless) — card recommends ~100Ohm, not yet updated to match | SDIO 3.0 | TBD | pending |
| `WIRELESS_SD0` | Compute-SoC <-> Wireless (bidirectional) | Compute-SoC <-> Wireless (bidirectional) | 1.8V | 30kOhm pull-up (Wireless) | SDIO 3.0 | TBD | pending |
| `WIRELESS_SD1` | Compute-SoC <-> Wireless (bidirectional) | Compute-SoC <-> Wireless (bidirectional) | 1.8V | 30kOhm pull-up (Wireless) | SDIO 3.0 | TBD | pending |
| `WIRELESS_SD2` | Compute-SoC <-> Wireless (bidirectional) | Compute-SoC <-> Wireless (bidirectional) | 1.8V | 30kOhm pull-up (Wireless) | SDIO 3.0 | TBD | pending |
| `WIRELESS_SD3` | Compute-SoC <-> Wireless (bidirectional) | Compute-SoC <-> Wireless (bidirectional) | 1.8V | 30kOhm pull-up (Wireless) | SDIO 3.0 | TBD | pending |
...
| `WIRELESS_WL_GPIO_10` | Wireless (AP6275S pin 33) <-> TBD (bidirectional-capable, target undecided) | Wireless (AP6275S pin 33) <-> TBD (bidirectional-capable, target undecided) | 1.8V | none | GPIO | n/a — purpose not yet decided | not addressed |
| `WIRELESS_WL_GPIO_11` | Wireless (AP6275S pin 35) <-> TBD (bidirectional-capable, target undecided) | Wireless (AP6275S pin 35) <-> TBD (bidirectional-capable, target undecided) | 1.8V | none | GPIO | n/a — purpose not yet decided | not addressed |
