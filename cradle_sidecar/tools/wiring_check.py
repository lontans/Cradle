...
used in cradle_sidecar/data/components/<PART>.md -- # | Name | Type | Vendor function |
...
Usage:
    python cradle_sidecar/tools/wiring_check.py <component_card.md> <source_designator> <target_designator> <target_name> <netlist.NET>
...
if __name__ == "__main__":
    if len(sys.argv) == 5 and sys.argv[1] == "--open":
        ...
        print("Usage:")
        print("  python cradle_sidecar/tools/wiring_check.py <component_card.md> <source_designator> <target_designator> <target_name> <netlist.NET>")
        print("  python cradle_sidecar/tools/wiring_check.py --open <component_card.md> <source_designator> <netlist.NET>")
        sys.exit(1)
