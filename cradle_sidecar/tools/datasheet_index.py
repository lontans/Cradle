...
`cradle_sidecar/data/components/<PART>.md` by hand. This script never touches that file.
...
def write_outline_md(pdf_path, toc, out_path):
    ...
    with open(out_path, "w", encoding="utf-8") as f:
        ...
        f.write(
            ...
            "findings into `cradle_sidecar/data/components/<PART>.md`, not here.\n\n"
        )
...
def write_index_md(pdf_path, rows, total_pages, narrative_pages, out_path):
    with open(out_path, "w", encoding="utf-8") as f:
        ...
        f.write(
            ...
            "`cradle_sidecar/data/components/<PART>.md`, not here.\n\n"
        )
...
def write_tables_md(pdf_path, ported_tables, out_path):
    with open(out_path, "w", encoding="utf-8") as f:
        ...
        f.write(
            ...
            "`cradle_sidecar/data/components/<PART>.md` by hand, including the Cradle Wiring and "
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print('Usage: python cradle_sidecar/tools/datasheet_index.py "path/to/datasheet.pdf" [output_prefix]')
        sys.exit(1)
