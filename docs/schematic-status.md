...
Sheet-by-sheet status of the Altium hierarchical schematic. Edit in place as sheets progress; log the *milestone* (sheet started/completed) in [CHANGELOG.md](../CHANGELOG.md).
