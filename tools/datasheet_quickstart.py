...
(docs/components/<PART>.md) is still a human/Claude-in-conversation task --
see docs/co-design-workflow.md and docs/workflow-cheatsheet.md.
...
def write_quickstart(prefix, pin_table_block, flagged, integration_pages, out_path):
    ...
    with open(out_path, "w", encoding="utf-8") as f:
        ...
        f.write(
            ...
            "real integration guidance into `docs/components/<PART>.md` is still a "
        ...
        if pin_table_block:
            ...
            f.write(
                ...
                "(see docs/co-design-workflow.md for known table-detection "
        ...
        if integration_pages is None:
            ...
            f.write(
                ...
                "circuit. See docs/co-design-workflow.md's External Validation "
                "convention.\n"
            )
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python datasheet_quickstart.py <prefix>")
