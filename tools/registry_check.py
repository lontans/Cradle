...
Parses docs/net-registry.md and checks each listed net name against the
...
which. See docs/co-design-workflow.md for that distinction.
...
if __name__ == "__main__":
    if len(sys.argv) < 3:
        print("Usage: python registry_check.py <net-registry.md> <netlist.NET>")
        sys.exit(1)
